local vars = {
    ...
    wsButton = Instance.new("TextButton"),
    jpButton = Instance.new("TextButton"),
    countdownTime = 3,
    isConfirming = false,
...
vars.btnIcon.Name = "vars.btnIcon"
...
vars.textButton3.Text = "Auto Equip Tools : OFF"
...
vars.Frame2.CanvasSize = UDim2.new(0, 0, 0, 425)
...
vars.Frame2.Parent = vars.screenGui
vars.Frame2.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
vars.Frame2.BorderColor3 = Color3.fromRGB(0, 0, 0)
vars.Frame2.BorderSizePixel = 0
vars.Frame2.Position = UDim2.new(0.88, 0, 0.05, 0)
vars.Frame2.Size = UDim2.new(0, 80, 0, 40)
vars.Frame2.Active = true
vars.Frame2.Draggable = false
vars.Frame2.Visible = false
vars.Frame2.ZIndex = 1

local UICorner1 = Instance.new("UICorner")
UICorner1.Parent = vars.Frame2
...
local function store()
    ...
    local backpack = vars.player:FindFirstChildOfClass("Backpack")
...
local function toggleAutoEquip()
    ...
    if autoEquip then
        vars.textButton3.Text = "Auto Equip Tools : ON"
        while autoEquip do
            if backpack and not vars.player.Character:FindFirstChildOfClass("Tool") then
                for _, tool in pairs(backpack:GetChildren()) do
                    if tool:IsA("Tool") and not table.find(lastTools, tool.Name) then
                        tool.Parent = vars.player.Character
                        local args = {
                            [1] = "Item",
                            [2] = "Keep"
                        }
...
local function YDYMLAX_fake_script()
    ...
    main.MouseButton1Click:Connect(function()
        V = not V
        if V then
            main.vars.btnIcon.ImageColor3 = Color3.fromRGB(0, 170, 255)
            ...
            main.vars.btnIcon.ImageColor3 = Color3.fromRGB(255, 255, 255)
            vars.buttonStroke.Color = Color3.fromRGB(0, 133, 199)
            vars.buttonStroke.Thickness = 2
            vars.buttonStroke.Transparency = 0.3
            EndForceShiftLock()
